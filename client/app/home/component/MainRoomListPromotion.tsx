...
import { fetchPostsPromotionalByPage } from "@/service/Marketing";
...
export default function MainPromotions({ data, page, size }: Props) {
    ...
    const handleFetchData = async () => {
        try {
            ...
            const dataResponseRooms = await fetchPostsPromotionalByPage(newPage, size);
